...
<script lang="ts">
	...
	import ConsentFormField from '$lib/components/forms/ConsentFormField.Svelte';
	...
	<div div class='w-1/2'>
		...
		>
			...
			{#each formFieldsTakingPart as { name, label }}
				<ConsentFormField {config} {name} {label} />
			{/each}
            ...
            <h2 class='text-xl'>So that the information you provide can be used legally by the researchers</h2>
