<script lang="ts">
	...
	import { challengeOverviewSchema, type ChallengeOverview } from '../data/schemas';
	...
	export let row: ChallengeOverview;
	...
	const currentEmail = challengeOverviewSchema.parse(row).email;
	const currentGroup = challengeOverviewSchema.parse(row).group as 'league' | 'global';
