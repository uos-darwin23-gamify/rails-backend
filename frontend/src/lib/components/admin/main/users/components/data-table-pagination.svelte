...
<div class="flex items-center space-x-6 lg:space-x-8 flex-wrap gap-2">
	...
	<div class="flex items-center space-x-2">
		<Button
			variant="outline"
			class="hidden h-8 w-8 p-0 lg:flex hover:bg-accent hover:text-accent-foreground bg-background"
		...
		<Button
			variant="outline"
			class="p-0 w-8 h-8 hover:bg-accent hover:text-accent-foreground bg-background"
