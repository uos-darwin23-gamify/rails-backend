	...
	<div class={cn('flex items-center', className)}>
		<DropdownMenu.Root>
			...
			<DropdownMenu.Content align="start">
				<DropdownMenu.Item class="cursor-pointer" on:click={handleAscSort}>Asc</DropdownMenu.Item>
				<DropdownMenu.Item class="cursor-pointer" on:click={handleDescSort}>Desc</DropdownMenu.Item>
				<DropdownMenu.Item class="cursor-pointer" on:click={props.sort.clear}
					>Clear Sort</DropdownMenu.Item
				>
