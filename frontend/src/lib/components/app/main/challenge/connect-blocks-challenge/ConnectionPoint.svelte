...
<div
	...
	class="non-draggable border-color bg-base-100 absolute box-content h-5 w-5 rounded-full border-2 hover:brightness-75 active:brightness-100 touch-none cursor-pointer"
